module.exports = function (ctf) {
    ...
    router.post(
        ...
        async function (req, res) {
            ...
            try {
                ...
                var r = await axios.post(url + "/instances", data, {
    ...
    router.get(
        ...
        async function (req, res) {
            ...
            try {
                var r = await axios.get(url + "/instances", {
                    headers: {Authorization: auth},
                });
    ...
    router.delete(
        ...
        async function (req, res) {
            ...
            try {
                await axios.delete(url + "/instances/" + req.params.name, {
                    headers: {Authorization: auth},
                });
            } catch (err) {
                console.log(err);
